...
type RBTreeOne struct {
	root   *TreeNode
	cur    *TreeNode
	create *TreeNode
}

func (rbt *RBTreeOne) Add(data float64) {
...
func (rbt *RBTreeOne) Delete(data float64) {
	var (
...
func (rbt *RBTreeOne) insertBalanceFixup(insertnode *TreeNode) {
	var uncle *TreeNode
	...
	for insertnode.color == "red" && insertnode.parent.color == "red" {
		...
		if uncle != nil && uncle.color == "red" {
			...
			//4○ <-new node ptr        4○
			//
			//这种情况可以一直循环，直到new node ptr指到root时退出(root颜色依然为黑)
...
func (rbt *RBTreeOne) deleteBalanceFixup(node *TreeNode) {
...
func (rbt RBTreeOne) GetRoot() *TreeNode {
	if rbt.root != nil {
		return rbt.root
	}
	return nil
...
func (rbt RBTreeOne) IsEmpty() bool {
	if rbt.root == nil {
		return true
	}
	return false
...
func (rbt RBTreeOne) InOrderTravel() {
...
func (rbt RBTreeOne) Search(data float64) *TreeNode {
...
func (rbt RBTreeOne) GetDeepth() int {
...
func (rbt RBTreeOne) GetMin() float64 {
...
func (rbt RBTreeOne) GetMax() float64 {
...
func (rbt RBTreeOne) GetPredecessor(data float64) *TreeNode {
...
func (rbt RBTreeOne) GetSuccessor(data float64) *TreeNode {
 ...
 */
func (rbt *RBTreeOne) LeftRotate(node *TreeNode) {
	if node.rchild == nil {
		return
	}
...
func (rbt *RBTreeOne) RightRotate(node *TreeNode) {
